...
public class Fragment_amusement extends Fragment {


    private static String url = "https://3g.163.com/touch/reconstruct/article/list/BA10TA81wangning/1-20.html";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ATTENTION!", "Fragment_AMUSEMENT is coming!!");
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (isVisibleToUser) {
            ...
            getNewsUtil.getNews(url, "BA10TA81wangning", newsItemList);
        }
