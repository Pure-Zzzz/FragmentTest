...
public class Fragment_Financial extends Fragment {

    private static String url = "https://3g.163.com/touch/reconstruct/article/list/BA8EE5GMwangning/1-20.html";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ATTENTION!", "Fragment_FINANCIAL is coming!!");
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (isVisibleToUser) {
            ...
            getNewsUtil.getNews(url, "BA8EE5GMwangning", newsItemList);
        }
