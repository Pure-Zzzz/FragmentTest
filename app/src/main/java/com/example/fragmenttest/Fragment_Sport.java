...
public class Fragment_Sport extends Fragment {
    ...
    private static String url = "https://3g.163.com/touch/reconstruct/article/list/BA8E6OEOwangning/1-20.html";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ATTENTION!", "Fragment_SPORT is coming!!");
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (isVisibleToUser) {
            ...
            getNewsUtil.getNews(url, "BA8E6OEOwangning", newsItemList);
        }
